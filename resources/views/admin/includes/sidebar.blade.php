            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                ...
                <li class="nav-item">
                    <a href="{{ route('product-categories.index') }}"
                        class="nav-link {{ $page == 'product-categories' ? 'active' : '' }}">
                ...
                <li class="nav-item">
                    <a href="{{ route('partnerships.index') }}"
                        class="nav-link {{ $page == 'partnerships' ? 'active' : '' }}">
                ...
                @if (Auth::user()->is_admin)
                    <li class="nav-item">
                        <a href="{{ route('expense-types.index') }}"
                            class="nav-link {{ $page == 'expense-types' ? 'active' : '' }}">
                ...
                @if (Auth::user()->is_admin)
                    ...
                    <li class="nav-item">
                        <a href="{{ route('expenses.index') }}"
                            class="nav-link {{ $page == 'expenses' ? 'active' : '' }}">
